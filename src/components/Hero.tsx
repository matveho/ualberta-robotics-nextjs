    ...
    <>
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              University of Alberta <br /> Robotics Association
            </h1>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white uppercase">
            {/* Trusted by <span className="text-indigo-600">2000+</span>{" "}
            customers worldwide */}
            Currently is not trusted by <span className="text-indigo-600">anyone</span>
          </div>

          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            <div className="pt-2 text-gray-400 dark:text-gray-400 text-center">
              Not Trusted by
              <AmazonLogo />
              yet*
            </div>
            <div className="text-gray-400 dark:text-gray-400 text-center">
              Not Trusted by
              <VerizonLogo />
              yet*
            </div>
            ...
            <div className="pt-1 text-gray-400 dark:text-gray-400 text-center">
              Not Trusted by
              <NetflixLogo />
              yet*
            </div>
